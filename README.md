...
- W aktualnym repo plik `arthor.py` powinien znajdowac sie w katalogu glownym projektu (obok `README.md`) lub w uzgodnionym miejscu, zaktualizowanym w README.
- Jesli push na GitHub jest odrzucany (`non-fast-forward`), wykonaj:
